        ...
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div>
                ...
                <p className='my-6 text-[15px] text-gray-500'>
                    Upload your images now and remove the background instantly —<br className='max-sm:hidden' /> fast, free, and hassle-free. Get a clean, professional look in just one click!</p>
                <div>
